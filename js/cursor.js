/* ==========================================================================
   CUSTOM CURSOR & PERFORMANCE CONTROLLER (DESKTOP ONLY)
   Ahmad Dhafin Al Farisy - Portfolio
   ========================================================================== */

(function initCleanPerformanceCursor() {
  // Check if device is Touchscreen / Mobile (coarse pointer)
  const isTouchDevice = window.matchMedia("(hover: none) and (pointer: coarse)").matches || "ontouchstart" in window;

  // If on mobile/touchscreen, terminate immediately to guarantee 100% native scroll speed & zero battery/GPU drain
  if (isTouchDevice) {
    return;
  }

  // =========================================================================
  // DESKTOP-ONLY SMOOTH GLOW CURSOR
  // =========================================================================
  ...
  // Smooth lerp for desktop glow bulb
  ...
  // Interactive Hover Effects on links and buttons for desktop
